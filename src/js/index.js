...
newGameBtn.addEventListener("click", () => {
  if (window.innerWidth >= 1024) {
    ...
    alert(
      "Infelizmente, nosso jogo não é adequado ao tamanho de tela do seu dispositivo, procure um dispositivo com uma tela maior e tente jogar novamente!"
    );
  }
});
...
const cardsData = {
  ...
  6: {
    ...
    image:
      "https://i0.wp.com/aliteraria26.com/wp-content/uploads/2023/12/castro-alves.jpg?resize=1024%2C1024&ssl=1",
  },
};
